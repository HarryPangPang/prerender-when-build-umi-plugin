  ...
  initialize() {
    ...
    return _asyncToGenerator(function*() {
      try {
        ...
        _this._options.args.push('--disable-web-security');
    ...
    return _asyncToGenerator(function*() {
      ...
      page.on('request', req => {
        const isLocalApi =
          ...
          req.url().startsWith(baseURL); // 跳过所有请求

        if (_this2._options.skipRequest && isLocalApi) {
          req.abort();
          return;
        }

        if (
          _this2._options.forceMock &&
          Object.prototype.toString.call(_this2._options.forceMock) ===
            '[object Object]' &&
          _this2._options.forceMock[req.url()]
        ) {
          req.respond({
            contentType: 'application/json; charset=utf-8',
            body: JSON.stringify(_this2._options.forceMock[req.url()]),
          });
          return;
        }
